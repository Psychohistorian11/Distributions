  ...
  distributions: Distribution[] = [
    {
      ...
      parameters: {'n (número de ensayos)': 'n = 1,2,3...',
    ...
    },
    {
      ...
      parameters: {'λ (tasa de ocurrencia)': 'λ > 0',
    ...
    },
    {
      ...
      parameters: {'θ_1' : "-♾️ < θ_1 < ♾️" , ' θ_2': "-♾️ < θ_2 < ♾️"},
    ...
    },
    {
      ...
      parameters: {'v (grados de libertad)': 'v > 0'},
    ...
    },
    {
      ...
      parameters: {'λ (parámetro de tasa)': 'λ > 0'},
    ...
    },
    {
      ...
      parameters: {'α (forma)': 'α > 0', ' β (tasa)': 'β > 0'},
    ...
    },
    {
      ...
      parameters: {'μ (media)' :"-♾️ < μ < ♾️", ' σ (desviación estándar)': 'σ > 0'},
